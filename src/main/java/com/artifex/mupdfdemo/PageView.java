...
public abstract class PageView extends ViewGroup {
	...
	private       OpaqueImageView mEntire; // Image rendered at minimum zoom
	...
	public void setOnloadSuccessListener(OnLoadSuccessListener mOnLoadSuccessListener){
		this.mOnLoadSuccessListener=mOnLoadSuccessListener;
	}
	...
	private void reinit() {
		// Cancel pending render task  取消等待线程任务
		if (mDrawEntire != null) {
	...
	public void setPage(final int page, PointF size) {
		...
		mDrawEntire = new CancellableAsyncTask<Void, Void>(getDrawPageTask(mEntireBm, mSize.x, mSize.y, 0, 0, mSize.x, mSize.y)) {
			...
			public void onPostExecute(Void result) {
				...
				mEntire.invalidate();
				mOnLoadSuccessListener.setLoadSuccess();
